...
export default function SignInPage() {
  ...
  const t = (key) => loginTranslations[key]?.[language] || loginTranslations[key]?.en || key;
  ...
  return (
    <div className="font-sans bg-black text-white min-h-screen flex items-center justify-center pt-20 pb-5 px-5 relative overflow-x-hidden">
      {/* Animated Background */}
      <div className="fixed w-full h-full top-0 left-0 -z-10 overflow-hidden">
        ...
        <div className="absolute rounded-full bg-gradient-to-br from-[#f093fb] to-[#f5576c] w-[400px] h-[400px] -bottom-[200px] -left-[100px] blur-[100px] opacity-50 animate-float" style={{ animationDelay: '5s' }}></div>
        <div className="absolute rounded-full bg-gradient-to-br from-[#4facfe] to-[#00f2fe] w-[300px] h-[300px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 blur-[100px] opacity-50 animate-float" style={{ animationDelay: '10s' }}></div>
      </div>

      {/* Back to Home */}
      <Link href="/" className="absolute top-12 left-12 flex items-center gap-2 text-white/80 text-sm transition-all duration-300 hover:text-white hover:-translate-x-1">
        ...
        <div className="glass backdrop-blur-20 rounded-[30px] p-12 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(102,126,234,0.1)]">
          <div className="text-center mb-10">
            ...
            <p className="text-white/80 text-base">
              {t('dontHaveAccount')}{' '}
              <Link href="/signup" className="text-indigo-400 hover:text-purple-400 transition-colors duration-300">
                {t('SignUp')}
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className={loading && !success ? 'pointer-events-none' : ''}>
            {/* Email */}
            <div className="mb-6">
            ...
            <div className="flex justify-between items-center mb-8 max-sm:flex-col max-sm:gap-4 max-sm:items-start">
              <div className="flex items-center gap-3">
                <div className="relative w-5 h-5">
                  ...
                  />
                  <div className={`checkbox-custom absolute top-0 left-0 w-5 h-5 ${
              ...
              <Link href="/forgot-password" className="text-sm text-indigo-400 hover:text-purple-400 transition-colors duration-300">
                {t('forgotPassword')}
              </Link>
            </div>
            ...
            {/* Success Checkmark */}
            {success && (
              <svg className="w-12 h-12 mx-auto mb-5 animate-scale-in" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
            ...
            <div className="relative text-center my-8">
              ...
              <span className="relative glass px-5 text-white/80 text-sm">Or continue with</span>
            </div>
            ...
            <div className="text-center text-white/80 text-sm">
              Need help?{' '}
              <Link href="/support" className="text-indigo-400 hover:text-purple-400 transition-colors duration-300">
                Contact Support
              </Link>
            </div>
          </form>
